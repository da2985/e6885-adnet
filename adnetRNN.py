...
class ADNET_v3(tf.keras.Model):
    ...
    def __init__(self):
        ...
        #self.action_history = tf.zeros(shape = (1,1, ADNET_v3.ACTION_DIM * ADNET_v3.K))
        self.action_history = tf.zeros(shape = (1,1, 512))
    ...
    def build(self, action_history):
      ...
      self.setActionHistory(action_history)

    def setActionHistory(self, action_history):
      #self.action_history = self.rnn.setActionHistory(action_history.reshape((1, 1, 1, ADNET_v3.ACTION_DIM * ADNET_v3.K)))
      self.action_history = self.rnn.setActionHistory(action_history.reshape((1, 1, 1, 512)))
...
class CustomRNN(layers.Layer):
    def __init__(self):
        ...
        #self.action_history = tf.zeros(shape = (1,1,1, ADNET_v3.ACTION_DIM * ADNET_v3.K))
    ...
    def call(self, input):
        ...
        self.action_history = new_action_history
